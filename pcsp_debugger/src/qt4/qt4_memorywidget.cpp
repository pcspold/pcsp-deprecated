...
QString qt4_MemoryWidget::getDisplayText()
{
  ...
  {
    case 16:
      Qt4_Translate::ByteToHex(text, m_data + m_topLeft, size);
      break;
    case 8:
      Qt4_Translate::ByteToOctal(text, m_data + m_topLeft, size);
      break;
    case 2:
      Qt4_Translate::ByteToBinary(text, m_data + m_topLeft, size);
      break;
    case -1:
      Qt4_Translate::ByteToChar(text, m_data + m_topLeft, size);
      break;
  }
  return text;
}
